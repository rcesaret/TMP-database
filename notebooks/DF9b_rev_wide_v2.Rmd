...
write.csv(data, paste0(DIR, "data/raw/DF9b_raw_data_v2.csv"), fileEncoding = "Latin1")
...
write.csv(data_char, paste0(DIR, "data/raw/data_char.csv"), fileEncoding = "Latin1")
```
CERANWK1
CERANWK2
CERANWK3
...
```{r}
write.csv(data_char, paste0(DIR, "data/raw/DF9b_data_char.csv"), fileEncoding = "Latin1")
```
